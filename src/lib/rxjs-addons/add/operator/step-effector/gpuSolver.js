...
const count = 1e1// MAX MEMORY SIZE
  ...
  initialize(count) {
    ...
    const megaKernelSpring = gpu.createKernelMap([
       ...
       */
        ...
        const force = (s + d);
        const a = force / mass;
        var o_velocity = velocity + (a * (t / 1000.0) * 1.0);
        return o_velocity;
      },
